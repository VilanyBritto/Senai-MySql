...
--
-- Host: mysql.wwonline.com.br    Database: wwonline14
-- ------------------------------------------------------
...
CREATE TABLE `endereco` (
  ...
  `uf_id` int(11) NOT NULL COMMENT 'Chave estranheira do ID da tabela UF',
  `municipio_id` int(11) NOT NULL COMMENT 'Chave strangeira ID da tabela Municipio',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'wwonline14'
--
...
-- Dump completed on 2022-08-17 21:31:19
